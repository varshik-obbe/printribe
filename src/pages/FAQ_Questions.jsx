...
const FAQ_Questions = () => {
  ...
  for (let i = 0; i < 30 && i < content[indexOfContent[params.id]].listOfQs.length; i++) {
  ...
  return (
    <>
      ...
      <div className={`${styles.faq_Q_container} container`}>
        ...
        <div className={styles.faq_Q_list} style={toDisplayQs.length >= 30 ? {paddingBottom:'200px'}:{paddingBottom:'50px'}}>
          ...
          <div className={styles.faq_Q_list_btn} style={toDisplayQs.length >= 30 ? {display:'block'}:{display:'none'}}>
            <button>
              Next{" "}
              <BsChevronRight
                style={{ fontSize: "16px" }}
