            ...
            <div className="container mt-5 mb-5" style={{padding:"0 8%"}}>
                ...
                <div className="row">
                    <div className={`col-lg-4 col-md-12 p-4 ${styles.standoutText}` }>
                        <p className="h5 fw-bold">No sign up fee</p>
                    ...
                    <div className={`col-lg-4 col-md-12 p-4 ${styles.standoutText}` }>
                        <p className="h5 fw-bold">White labelled</p>
                    ...
                    <div className={`col-lg-4 col-md-12 p-4 ${styles.standoutText}` }>
                        <p className="h5 fw-bold">Ecommerce integration</p>
