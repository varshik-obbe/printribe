        ...
        <>
            ...
            <h2 className={styles.fulfill_title}>
                ...
                <div className="row">
                    <div className="col-lg-3 col-sm-6 p-3 mb-4">
                        <div className="card" style={{ maxWidth: "100%", height: "100%" }}>
                            ...
                            <div className="card-body" style={{ height: "25%" }}>
                                <p className={`card-text fw-bold mb-1 ${styles.avenir}`} style={{fontWeight:"900"}} id={styles.card_product_title} >T-shirts</p>
                                <span className={`${styles.avenir}`} style={{ fontWeight: "300" ,fontSize:"14px"}}>
                    ...
                    <div className="col-lg-3 col-sm-6 p-3  mb-4">
                        <div className="card" style={{ maxWidth: "100%", height: "100%" }}>
                            ...
                            <div className="card-body" style={{ height: "25%" }}>
                                <p className={`card-text fw-bold mb-1 ${styles.avenir}`} id={styles.card_product_title} >T-shirts</p>
                                <span className={`${styles.avenir}`} style={{ fontWeight: "300",fontSize:"14px" }}>
                                    Starting from ₹175 only</span>
                            </div>
                        </div>
                ...
                <div className="text-center mt-4 mb-4">
                  <a href="/products"> <button className="btn btn-danger px-3 py-2" style={{backgroundColor:"#EE3C2F",fontFamily:"Avenir,sans-serif",fontSize:"16px",letterSpacing:"1.6px",fontWeight:"700"}}>All products</button></a> 
                </div>
