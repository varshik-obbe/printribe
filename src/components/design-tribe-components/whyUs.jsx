...
{title:"Access new graphics, mockups, and tools",body:"Up your design game with constant Design Tribe improvements"},]

function whyUs(){
    return(<div className={styles.whyUsContainer}>
        <div className={styles.whyUsHeader}>Why go with our Design Tribe?</div>
        <div className={styles.whyUsImgContainer}>
            <img width="100%" className={styles.whyUsImg}  src="https://static.cdn.printful.com/static/v838/images/layout/design-maker/why-go-with-design-maker-block/why-illustration.png" alt="why-us-image" />
        </div>
