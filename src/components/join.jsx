        ...
        <>
            <div className="container-fluid mt-3 mb-3" style={{background:"rgb(255 241 201)"}}>
                <div className="container text-center p-4">
                    ...
                    <button className="text-center btn btn-danger" onClick={goToDesign} style={{fontFamily:"roboto-bold,roboto,sans-serif",backgroundColor:"#EE3C2F",fontSize:"16px",fontWeight:"600"}}> Get Started  {' > '} </button>
                </div>
            </div>
        </>
    )
